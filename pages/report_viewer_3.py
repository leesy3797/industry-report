...
company_trend_reports = load_reports_from_db(report_type='trend', company=report_query_display, year=datetime.datetime.now().year, month=None)

if company_trend_reports:
    # 기업 트렌드 분석은 단일 보고서이므로 최신 하나만 보여줍니다.
